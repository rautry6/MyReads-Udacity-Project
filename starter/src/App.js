...
const [read, setRead] = useState([
 ...
 const changeBookshelf = (originalBookshelf, book, newBookshelf) =>{
    if(originalBookshelf === "currentlyReading"){
      ...
      else if(newBookshelf === "wantToRead"){
        setWantToRead([...wantToRead, book]);
      }
      else if(newBookshelf === "read"){
        setRead([...read, book]);
      }
      ...
      {showSearchPage ? (
        ...
        <div className="list-books">
          ...
          <div className="list-books-content">
            <div>
              <Bookshelf bookshelfName="Currently Reading" books={currentlyReading} changeBookshelf = {changeBookshelf}/>
              <Bookshelf bookshelfName="Want To Read" books={wantToRead} changeBookshelf = {changeBookshelf}/>
              <Bookshelf bookshelfName="Read" books={read} changeBookshelf = {changeBookshelf}/>
            </div>
          </div>
